...
instalação  ou  estrutura  de  perfuração,  produção,
...
37.3.1  Cabe  à  operadora  da
instalação,  além  do  disposto  nas  demais  Normas
...
a)
possuir profissional de saúde, registrado no respectivo conselho de classe, embarcado
...
ser dotada de enfermaria que atenda ao descrito no Capítulo 9 da NORMAM-01/DPC
...
básico  de  vida  e  trauma  pré-hospitalar,  certificados  por
...
integralmente  embarcados  na  plataforma  onde  estão
...
37.8 Comissão Interna de Prevenção de Acidentes em Plataformas – CIPLAT (Portaria MTP nº
...
d) providenciar  banheiros  químicos  para  os
...
máximo  de
instalados  nos  camarotes  permanentes,  observada  a
...
legalmente  habilitado,  apresentando  o  comprovante  ao
...
sauna,  essas
instalações  devem  ser  mantidas  em  funcionamento,  só  podendo  ser
...
instrumentos,  máquinas,  sistemas  e  acessórios  da
...
instruções  dos  manuais  de  operação  e  de  manutenção  elaborados  pelos
...
d) medidas  corretivas  adotadas  para  as  não  conformidades
...
37.23.2  Os  detectores  e  alarmes  fixos  devem  ser
dimensionamento de projeto e suas atualizações, inclusive nas instalações temporárias.

instalados  de  acordo  com  o

37.23.3  As botoeiras de acionamento do alarme de incêndio devem ser do tipo “Quebre o
...
periodicamente  por  profissional  capacitado,  conforme
...
a)  Nome  da  operadora  da

instalação,  endereço,  CNPJ,
